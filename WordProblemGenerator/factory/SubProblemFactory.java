...
import WordProblemGenerator.template.SubProblemTemplate;
...
import WordProblemGenerator.workbook.answer.SubProblemAnswer;

import java.util.ArrayList;
import java.util.Collections;
import java.util.List;

public class SubProblemFactory extends ProblemFactory {
    public SubProblemFactory() {
    ...
    public String createProblem(ProblemInfo problemInfo) {
        ...
        WordProblemTemplate wordProblemTemplate = new SubProblemTemplate();
    ...
    public Integer createAnswer() {
        ProblemAnswer problemAnswer = new SubProblemAnswer();
